...
for year in tqdm(years):
    ...
    for file in tqdm(files):
        ...
        # extract only the birds that arrived in Europe
        if 'birds_in_europe' in globals():
            birds_in_europe = pd.concat([birds_in_europe, joined[joined['continent'] == 'Europe']], ignore_index=True)
        else:
            birds_in_europe = joined[joined['continent'] == 'Europe']
#save to pickle
birds_in_europe.to_pickle(path+'birds_in_europe.p')